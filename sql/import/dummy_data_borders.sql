...
-- Create the countries by creating geom_by_borders attributes
...
SELECT vtm.insert_properties_helper('Switzerland'::text, 'state'::text, 'Dummy'::text, 'geom_by_borders'::text, NULL, NULL, (currval('vtm.entities_id_seq')-2)::text); --/!\ id changed
SELECT vtm.insert_properties_helper('Switzerland'::text, 'state'::text, 'Dummy'::text, 'geom_by_borders'::text, NULL, NULL, (currval('vtm.entities_id_seq')-1)::text);
...
SELECT vtm.insert_properties_helper('France'::text, 'state'::text, 'Dummy'::text, 'geom_by_borders'::text, NULL, NULL, (currval('vtm.entities_id_seq')-3)::text); --/!\ id changed
