...
FROM   (
	*/SELECT 	vtm.insert_properties_helper('Isola 1360 '||id, 'isola'::text, 'Isabella draft', 'geom'::text, 1360, 'default'::vtm.interpolation_type, ST_AsText(ST_CollectionExtract(ST_MakeValid(ST_Transform(geom,4326)),3))) as pid,
			id as id
...
FROM   (
	*/SELECT 	vtm.insert_properties_helper('Isola 12th '||id, 'isola'::text, 'Isabella draft', 'geom'::text, 1150, 'default'::vtm.interpolation_type, ST_AsText(ST_CollectionExtract(ST_MakeValid(ST_Transform(geom,4326)),3))) as pid,
			id as id
...
FROM   (
	*/SELECT 	vtm.insert_properties_helper('Canal 1360 '||id, 'canal'::text, 'Isabella draft', 'geom'::text, 1360, 'default'::vtm.interpolation_type, ST_AsText(ST_CollectionExtract(ST_MakeValid(ST_Transform(geom,4326)),3))) as pid,
			id as id
...
FROM   (
	*/SELECT 	vtm.insert_properties_helper('Canal 12th '||id, 'canal'::text, 'Isabella draft', 'geom'::text, 1150, 'default'::vtm.interpolation_type, ST_AsText(ST_CollectionExtract(ST_MakeValid(ST_Transform(geom,4326)),3))) as pid,
			id as id
	FROM	"data_draft_idl"."xiisec_can" as t/*
	) as sub*/;


	SELECT 	vtm.insert_properties_helper('Building 1808 '||id, 'building'::text, 'Isabella draft', 'geom'::text, 1808, 'default'::vtm.interpolation_type, ST_AsText(ST_CollectionExtract(ST_MakeValid(ST_Transform(geom,4326)),3))) as pid,
			id as id
...
FROM   (
	*/SELECT 	vtm.insert_properties_helper('Building 1360 '||id, 'building'::text, 'Isabella draft', 'geom'::text, 1360, 'default'::vtm.interpolation_type, ST_AsText(ST_CollectionExtract(ST_MakeValid(ST_Transform(geom,4326)),3))) as pid,
			id as id
...
FROM   (
	*/SELECT 	vtm.insert_properties_helper('Building 13th '||id, 'building'::text, 'Isabella draft', 'geom'::text, 1250, 'default'::vtm.interpolation_type, ST_AsText(ST_CollectionExtract(ST_MakeValid(ST_Transform(geom,4326)),3))) as pid,
			id as id
...
FROM   (
	*/SELECT 	vtm.insert_properties_helper('Building 12th '||id, 'building'::text, 'Isabella draft', 'geom'::text, 1150, 'default'::vtm.interpolation_type, ST_AsText(ST_CollectionExtract(ST_MakeValid(ST_Transform(geom,4326)),3))) as pid,
			id as id
